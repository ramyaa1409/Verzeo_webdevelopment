...
def extractSkin(image):
    ...
    lower_threshold = np.array([0, 50, 80], dtype=np.uint8)
    print(lower_threshold)
    upper_threshold = np.array([60, 255, 255], dtype=np.uint8)
...
@app.route('/upload',methods=['POST'])#upload pic
def verzeo():
    rgb_lower = [80, 51, 53]
    rgb_higher = [255, 219, 172]

    skin_shades = {
        'dark': [[0, 0, 0, ], [140, 95, 80]],
        'mild': [[140, 95, 80], [158, 115, 80]],
        'fair': [[158, 115, 80], [255, 225, 255]],
    ...
    if int(request.form.get('isurl')) != 0:
        # https: // fantasysportsking. in / wp - content / uploads / 2020 / 12 / 78465514_1285803821621996_9168391984405020672_n.jpg
        ...
        #display.Image("./image/image.jpg")
        #image=Image(filename="./image/image.jpg")
